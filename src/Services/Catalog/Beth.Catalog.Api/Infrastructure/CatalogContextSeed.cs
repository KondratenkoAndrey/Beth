...
public static class CatalogContextSeed
{
    public static async Task SeedAsync(CatalogContext context)
    {
        ...
        {
            var nike = new CatalogBrand { Brand = "Nike"};
            var intel = new CatalogBrand { Brand = "Intel" };
            var ikea = new CatalogBrand { Brand = "Ikea" };
            var newBalance = new CatalogBrand { Brand = "New Balance" };
            await context.CatalogBrands.AddRangeAsync(nike, intel, ikea, newBalance);
            
            var clothes = new CatalogType { Type = "Clothes"};
            var electronics = new CatalogType { Type = "Electronics" };
            var furniture = new CatalogType { Type = "Furniture" };
            var shoes = new CatalogType { Type = "Shoes" };
            await context.CatalogTypes.AddRangeAsync(clothes, electronics, furniture, shoes);

            await context.CatalogItems.AddRangeAsync(
                new CatalogItem
                {
                    CatalogType = clothes, CatalogBrand = nike, AvailableStock = 100,
                    Description = "special cotton shirt for men", Name = "shirt for men", Price = 19.5M,
                    PictureFileName = "1.png"
                },
                new CatalogItem
                {
                    CatalogType = clothes, CatalogBrand = nike, AvailableStock = 100,
                    Description = "igh quality men distress skinny blue jeans", Name = "skinny blue jeans",
                    Price = 8.50M, PictureFileName = "2.png"
                },
                new CatalogItem
                {
                    CatalogType = clothes, CatalogBrand = nike, AvailableStock = 100,
                    Description = "men casual shoes sports running sneakers", Name = "casual shoes", Price = 12,
                    PictureFileName = "3.png"
                },
                new CatalogItem
                {
                    CatalogType = electronics, CatalogBrand = intel, AvailableStock = 100,
                    Description = "Intel Core i9 (12th Gen) i9-12900KS Hexadeca-core (16 Core) 2.50 GHz Processor",
                    Name = "i9-12900KS", Price = 1200, PictureFileName = "4.png"
                },
                new CatalogItem
                {
                    CatalogType = electronics, CatalogBrand = intel, AvailableStock = 100,
                    ...
                    Name = "i7-12700KF", Price = 356.5M, PictureFileName = "5.png"
                },
                new CatalogItem
                {
                    CatalogType = electronics, CatalogBrand = intel, AvailableStock = 100,
                    ...
                    Name = "i5-11600KF", Price = 340, PictureFileName = "6.png"
                },
                new CatalogItem
                {
                    CatalogType = furniture, CatalogBrand = ikea, AvailableStock = 100,
                    Description = "Organizer, plastic/beige", Name = "Organizer", Price = 0.59M,
                    PictureFileName = "7.png"
                },
                new CatalogItem
                {
                    CatalogType = furniture, CatalogBrand = ikea, AvailableStock = 100, Description = "Cabinet, white",
                    Name = "Cabinet", Price = 139.5M, PictureFileName = "8.png"
                },
                new CatalogItem
                {
                    CatalogType = furniture, CatalogBrand = ikea, AvailableStock = 100, Description = "Bed frame",
                    Name = "Bed", Price = 239, PictureFileName = "9.png"
                },
                new CatalogItem
                {
                    CatalogType = shoes, CatalogBrand = newBalance, AvailableStock = 100,
                    Description =
                        "This model runs large, compared to previous versions. You may consider ordering down from your normal size.",
                    Name = "Fresh Foam X 1080v12", Price = 159, PictureFileName = "10.png"
                },
                new CatalogItem
                {
                    CatalogType = shoes, CatalogBrand = newBalance, AvailableStock = 100,
                    Description =
                        "Our Numeric 440 blends premier technology with soft cushioning to create a go-to shoe for both everyday skate and wear.",
                    Name = "NB Numeric 440", Price = 89.99M, PictureFileName = "11.png"
                },
                new CatalogItem
                {
                    CatalogType = shoes, CatalogBrand = newBalance, AvailableStock = 100,
                    Description =
                        "Our off-field inspired FreezeLX v4 Turf has a specially designed NDurance outsole for traction, durability and versatility on field turf surfaces.",
                    Name = "FreezeLX v4 Turf", Price = 104.99M, PictureFileName = "12.png"
                }
            );
