...
namespace Beth.Catalog.Api.Infrastructure.Migrations
{
    ...
    [Migration("20230102095005_delete_behavior")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Beth.Catalog.Api.Models.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Beth.Catalog.Api.Models.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Beth.Catalog.Api.Models.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Beth.Catalog.Api.Models.CatalogItem", b =>
                {
                    b.HasOne("Beth.Catalog.Api.Models.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Beth.Catalog.Api.Models.CatalogType", "CatalogType")
                        .WithMany()
